...
def main(args):
    ...
    # init()
    result = request_analysis(sock, context, word_list, pos_list)
...
def establish_connection(host = "127.0.0.1", port = 55556):
...
def request_analysis(sock, context, word_list, pos_list):
    
    sentence = '@'.join([context, word_list, pos_list])
...
if __name__ == '__main__':
    ...
    if len(args) != 5:
        ...
        args = ['', 'en', 'It is really cold today.', 'it,is,really,cold,today', 'n,v,r,a,r']
