...
import greta.core.keyframes.face.CancelableAUPerformer;
 ...
 * @author Jieyeon Woo
 */
public class ASAPSimpleAUPerformer extends FAPFrameEmitterImpl implements CancelableAUPerformer, CharacterDependent {
    ...
    public ASAPSimpleAUPerformer (CharacterManager cm){
        characterManager = cm;
    ...
    public FAPFrame toFAPFrame_ASAP(AUAPFrame auFrame) {
        ...
        int[] upau_list = {1,2,4,5,6,7,12,45,61,62,63,64};
