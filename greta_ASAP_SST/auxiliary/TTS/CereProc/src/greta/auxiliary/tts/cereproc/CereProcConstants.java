...
public class CereProcConstants {
    ...
    public static void init(){
        ...
        correspondingPhonemes.put("ja-JP", new HashMap<String,PhonemeType[]>());
    ...
    public static void InitPhonemes() {
        ...
        //
        // Japanese
        addGretaCereProcPhonemeCorrespondence("ja-JP", "sil", PhonemeType.pause);
        addGretaCereProcPhonemeCorrespondence("ja-JP", "a", PhonemeType.a1);
        addGretaCereProcPhonemeCorrespondence("ja-JP", "ah", PhonemeType.a);
        addGretaCereProcPhonemeCorrespondence("ja-JP", "ae", PhonemeType.E1);
        addGretaCereProcPhonemeCorrespondence("ja-JP", "aeh", PhonemeType.E1);
        addGretaCereProcPhonemeCorrespondence("ja-JP", "e", PhonemeType.e);
        addGretaCereProcPhonemeCorrespondence("ja-JP", "eh", PhonemeType.e);
        addGretaCereProcPhonemeCorrespondence("ja-JP", "i", PhonemeType.i);
        addGretaCereProcPhonemeCorrespondence("ja-JP", "ih", PhonemeType.i);
        addGretaCereProcPhonemeCorrespondence("ja-JP", "o", PhonemeType.o);
        addGretaCereProcPhonemeCorrespondence("ja-JP", "oh", PhonemeType.o);
        addDoubleGretaCereProcPhonemeCorrespondence("ja-JP", "oi", PhonemeType.o, PhonemeType.i);
        addGretaCereProcPhonemeCorrespondence("ja-JP", "oe", PhonemeType.e);
        addGretaCereProcPhonemeCorrespondence("ja-JP", "oeh", PhonemeType.e);
        addGretaCereProcPhonemeCorrespondence("ja-JP", "u", PhonemeType.u);
        addGretaCereProcPhonemeCorrespondence("ja-JP", "uh", PhonemeType.u);
        addGretaCereProcPhonemeCorrespondence("ja-JP", "ue", PhonemeType.u1);
        addGretaCereProcPhonemeCorrespondence("ja-JP", "ueh", PhonemeType.u1);
        addGretaCereProcPhonemeCorrespondence("ja-JP", "p", PhonemeType.p);
        addGretaCereProcPhonemeCorrespondence("ja-JP", "b", PhonemeType.b);
        addGretaCereProcPhonemeCorrespondence("ja-JP", "t", PhonemeType.t);
        addGretaCereProcPhonemeCorrespondence("ja-JP", "d", PhonemeType.d);
        addGretaCereProcPhonemeCorrespondence("ja-JP", "g", PhonemeType.g);
        addGretaCereProcPhonemeCorrespondence("ja-JP", "k", PhonemeType.k);
        addGretaCereProcPhonemeCorrespondence("ja-JP", "f", PhonemeType.f);
        addGretaCereProcPhonemeCorrespondence("ja-JP", "h", PhonemeType.r);        
