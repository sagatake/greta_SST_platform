...
//    private String duration_file_path = "D:\\Takeshi\\SST\\SST_main\\greta_python\\audio_duration.txt";
    private String duration_file_path = System.getProperty("user.dir") + "\\Scripts\\SST\\audio_duration.txt";
    ...
    public void compute(boolean doTemporize, boolean doAudio, boolean doPhonems) {
        ...
        if(doAudio){
            ...
            try {
                ...
                try{
                    File file = new File(duration_file_path);
                    FileWriter filewriter = new FileWriter(file);

                    //filewriter.write("hello"+"\n");

                    //double test = 10.0;
                    String str = String.valueOf(audio.getDuration());
