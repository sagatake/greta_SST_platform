...
//    private String sstLanguage = null;
    ...
    public boolean init(){
        ...
        sstTask = singletoneInstance.getSSTTask();
        sstTaskIndex = singletoneInstance.getSSTTaskIndex();
        this.manager = new FMLManager(host, port, gretaInputTopic, flipperTemplateFolder, sstTask, sstTaskIndex);
        
        System.out.println("flipperTemplateFolder: " + flipperTemplateFolder);
        System.out.println("FMLGenerator initialized");

        return true;
    }
    public boolean init(String host, String port, String senderFmlTopic, String flipperTemplateFolder, String sstTask, String sstTaskIndex){
        this.manager = new FMLManager(host, port, senderFmlTopic,flipperTemplateFolder, sstTask, sstTaskIndex);
        System.out.println("FMLGenerator initialized");
        return true;
    }
    ...
    public void executeTemplate(String json) {
        ...
        System.out.println("FMLGenerated");
        System.out.println("KeySet");
        System.out.println(new ArrayList<>(fml.keySet()));
        System.out.println("Values");
        System.out.println(new ArrayList<>(fml.values()));
