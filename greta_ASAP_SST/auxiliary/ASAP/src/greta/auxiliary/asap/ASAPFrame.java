...
public class ASAPFrame extends javax.swing.JFrame implements AUEmitter, BAPFrameEmitter{
    ...
    public ASAPFrame() {
        ...
        check_box_pairs.add(new Pair<>(bouche,"AU25"));
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Reciprocal Adaptation", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 3, 24))); // NOI18N
        ...
        address.setText("163.221.201.131");
...
//                                    || (au_correspondance[au] == 26 && check_box_pairs.get(8).getKey().getState())) {
                            if ((au_correspondance[au] == 1 && check_box_pairs.get(0).getKey().getState())|| (au_correspondance[au] == 2 && check_box_pairs.get(1).getKey().getState()) 
                                    || (au_correspondance[au] == 4 && check_box_pairs.get(2).getKey().getState())|| (au_correspondance[au] == 5 && check_box_pairs.get(3).getKey().getState()) 
                                    || (au_correspondance[au] == 6  && check_box_pairs.get(4).getKey().getState())|| (au_correspondance[au] == 7 && check_box_pairs.get(5).getKey().getState())
                                    || (au_correspondance[au] == 12 && check_box_pairs.get(7).getKey().getState())
                                ) {
                                ...
                                if (isNumeric(value)) {
                                    ...
                                    // exclude au12, au25, au26
//                                    if ((au_correspondance[au] != 12) && (au_correspondance[au] != 25) && (au_correspondance[au] != 26)) {
                                        au_frame.setAUAPboth(au_correspondance[au], intensity);
//                                    } 
//                                    else {
//                                        au_frame.setAUAPboth(au_correspondance[au], au_frame.getAUAPleft(au_correspondance[au]));
//                                    }
                        ...
                        au_frame.setAUAPboth(45, blink); //prev 43?
                        prev_blink = blink;
                ...
                while ((line = br.readLine()) != null) {
                    ...
                    for (int au = 1; au < au_to_col.length; au++) {
                        ...
                        if (isNumeric(value)) {
                            ...
                            // exclude au12, au25, au26
//                            if ((au_correspondance[au-1] != 12) && (au_correspondance[au-1] != 25) && (au_correspondance[au-1] != 26)) {
                            if ((au_correspondance[au-1] != 25) && (au_correspondance[au-1] != 26)) {
